...
def _get_filenames_and_classes(dataset_dir,category):
  ...
  """
  root = os.path.join(dataset_dir, category)
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
  output_filename = 'color_%s_%05d-of-%05d.tfrecord' % (split_name, shard_id, _NUM_SHARDS)
...
if __name__ == '__main__':
    ...
    #the dir where is data saved
    dataset_dir=r'D:\TF_Try\color\data'
    run(dataset_dir)