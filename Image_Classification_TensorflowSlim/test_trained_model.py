# -*- coding: utf-8 -*-
"""
Created on Wed Feb 28 19:22:22 2018
...
def prediction(graph,test_img_path_class,test_imgs):
    ...
    print("the data we test is : ",test_img_path_class)
    ...
    for img in test_imgs:
        ...
        image = os.path.join(test_img_path_class,img)
...
if __name__ == "__main__":
    ...
    test_img_dir = r'/media/network_shared_disk/WangTao/Person_attributes_detection/gender_data/validation/'
  
    subfolder = os.listdir(test_img_dir)
  
    img_class = len(subfolder)
  
    test_img_path_male = os.path.join(test_img_dir,'male')
    test_img_path_female = os.path.join(test_img_dir,'female')
    
    test_imgs_male = os.listdir(test_img_path_male)
  
    test_imgs_female = os.listdir(test_img_path_female)
    
    prediction(graph,test_img_path_female,test_imgs_female)
