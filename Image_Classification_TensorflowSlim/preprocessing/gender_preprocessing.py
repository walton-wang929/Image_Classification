...
Provides utilities to preprocess gender images for the Inception networks.
...
def apply_with_random_selector(x, func, num_cases):
  ...
  Returns:
    The result of func(x, sel), where func receives the value of the selector as a python integer, but sel is sampled dynamically.
  """
...
def preprocess_for_eval(image, height, width,
  ...
  with tf.name_scope(scope, 'eval_image', [image, height, width]):
    ...
    if central_fraction:
	  ...
	  #tf.summary.image('central_fraction_image', image)
