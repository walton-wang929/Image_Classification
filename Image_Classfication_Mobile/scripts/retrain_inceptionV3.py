# -*- coding: utf-8 -*-
"""
Created on Fri Feb  9 11:32:53 2018

@author: TWang

Retrain network, not using fine-trained network
...
def main(_):
  ...
  with tf.Session(graph=graph) as sess:
    ...
    #print misclassified test images and save them as text file
    misclassified_list = []
    if FLAGS.print_misclassified_test_images:
      ...
      for i, test_filename in enumerate(test_filenames):
        if predictions[i] != test_ground_truth[i].argmax():
          ...
          misclassified_list.append(test_filename)
